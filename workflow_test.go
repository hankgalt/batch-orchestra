	...
	req := &LocalCSVSQLLiteBatchRequest{
		...
		Policies: map[string]domain.RetryPolicySpec{
			...
			domain.GetWriteActivityName(sinkCfg): {
				...
				NonRetryableErrorTypes: []string{
					sinks.ERR_SQLLITE_SINK_NIL,
					sinks.ERR_SQLLITE_SINK_NIL_CLIENT,
					sinks.ERR_SQLLITE_SINK_EMPTY_TABLE,
					sinks.ERR_SQLLITE_SINK_DB_FILE_REQUIRED,
					sinks.ERR_SQLLITE_SINK_ALL_BATCH_RECORDS,
				},
			},
		},
	}
